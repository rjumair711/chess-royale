    ...
    document.querySelectorAll(".box").forEach((image) => {
      if (image.innerText.length !== 0) {
        if (image.innerText == "Wpawn" || image.innerText == "Bpawn") {
          image.innerHTML = `${image.innerText} <img class='all-img all-pown' src="/ChessImages/${image.innerText}.png" alt="">`;
          image.style.cursor = "pointer";
        } else {
          image.innerHTML = `${image.innerText} <img class='all-img' src="/ChessImages/${image.innerText}.png" alt="">`;
          image.style.cursor = "pointer";
        }
      }
    });
...
if (tog % 2 !== 0) {
    ...
    document.getElementById("tog").style.backgroundColor = "#fff";
    document.getElementById("tog").style.color = "#000";
    document.getElementById("tog").style.border = "2px solid #fff";
    whosTurn("W");
} else {
    document.getElementById("tog").innerText = "Black's Turn";
    document.getElementById("tog").style.backgroundColor = "#000";
    document.getElementById("tog").style.color = "#fff";
    document.getElementById("tog").style.border = "2px solid #000";
    whosTurn("B");
}
...
reddish();
  ...
  //Prevent from selecting multiple elements
  z = 0;
  document.querySelectorAll(".box").forEach((e) => {
    e.addEventListener("click", function () {
      z = z + 1;
      if (z % 2 == 0 && e.style.backgroundColor !== "greenyellow") {
        coloring();
      }
    });
  });
